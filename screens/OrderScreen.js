...
const OrderScreen = () => {
    ...
    return (
        <SafeAreaView>
            ...
            <TouchableOpacity style={{ marginTop: 150, borderColor: "gray", borderWidth: 2, width: 150, padding: 10, marginLeft: "auto", marginRight: "auto", borderRadius: 10 }} onPress={() => navigation.navigate("Home")}>
